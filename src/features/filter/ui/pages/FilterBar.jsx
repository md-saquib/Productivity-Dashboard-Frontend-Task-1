                    ...
                    return (
                        <div key={filter.key} className="relative inline-block">
                            <select
                                ...
                                className={`
                                    appearance-none pl-3 pr-8 rounded-lg text-xs font-medium border
                                    outline-none cursor-pointer transition-all hover:opacity-90
                                    min-h-[44px]
                                    ${isSelected
                                        ? "bg-[var(--surface-container-high)] border-[var(--primary)] text-[var(--on-surface)]"
                                        : "bg-[var(--surface-container-low)] border-[var(--border-subtle)] text-[var(--text-secondary)]"
                                    }
                                `}
                            >
